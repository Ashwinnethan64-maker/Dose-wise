        ...
        <div className="flex flex-col items-center gap-6 w-full animate-fade-in">
            ...
            <div className="flex flex-wrap justify-center gap-4 w-full max-w-[420px]">
                {!cameraActive ? (
                    <button
                        onClick={startCamera}
                        className="flex-1 min-w-[160px] bg-primary-500 hover:bg-primary-600 active:scale-[0.97] text-white text-base font-bold py-4 px-6 rounded-2xl shadow-btn transition-all duration-200 flex items-center justify-center gap-3"
                    >
                    ...
                    <>
                        <button
                            onClick={stopCamera}
                            className="flex-1 min-w-[130px] bg-medical-danger hover:brightness-110 active:scale-[0.97] text-white text-base font-bold py-4 px-5 rounded-2xl shadow-btn transition-all duration-200 flex items-center justify-center gap-2"
                        >
                        ...
                        {!captured ? (
                            <button
                                ...
                                className="flex-1 min-w-[130px] bg-primary-700 hover:bg-primary-800 active:scale-[0.97] text-white text-base font-bold py-4 px-5 rounded-2xl shadow-btn transition-all duration-200 flex items-center justify-center gap-2"
                            >
                                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 0 0-1.134-.175 2.31 2.31 0 0 1-1.64-1.055l-.822-1.316a2.192 2.192 0 0 0-1.736-1.039 48.774 48.774 0 0 0-5.232 0 2.192 2.192 0 0 0-1.736 1.039l-.821 1.316Z" />
                            ...
                            <button
                                onClick={resumeLive}
                                className="flex-1 min-w-[130px] bg-primary-500 hover:bg-primary-600 active:scale-[0.97] text-white text-base font-bold py-4 px-5 rounded-2xl shadow-btn transition-all duration-200 flex items-center justify-center gap-2"
                            >
                                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
